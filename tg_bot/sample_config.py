...
class Config(object):
    ...
    # REQUIRED
    API_KEY = "1109246758:AAGqoznf7e5VVG4NXXhWsUsh5SMo83Zh5fc"
    ...
    SUPPORT_USERS = [797768146]  # List of id's (not usernames) for users which are allowed to gban, but can also be banned.
